...
### 吸い出しついて
吸い出しについては<color>基本違法です。</color>  
「ソフトを持っていれば良い」という風潮がありますが、それは古めのものだけです。  
  
<br>
判断としては、レトロフリークで遊べる種類については問題ないとしたほうが良いようです。  
それ以降のPS1やNintendo64、ましてはSwitchのゲームは  
コピープロテクトされており、それを解除するのが違法となります。  
YouTubeとかでおっさんが中華エミュ機のレビューと一緒にプレイしていますが、、  
